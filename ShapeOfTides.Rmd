...
The goal of this project is to analyse tide times in Galway and try to extract some information on the periodicity of tide times.
...
```{r}
tides <- read.csv(file="/Users/michaelmcgloin/Downloads/galwaytides.csv", nrows=3411, header=FALSE)
height <- tides[,8]
```
